...
testxx1 = [];%This is to store iterative convergence of location x
testxx2 = [];%This is to store iterative convergence of location y
testxx3 = [];%This is to store iterative convergence of orientation theta
testxx4 = [];%This is to store iterative convergence of speed v
...
for i = 1 : (nsim-1)
   ...
   for j = 1 : K
    ...
    if i == 6 %Get several open-loop trajectories at different iterations predicted at t = 6
     testxx1 = [testxx1; ctrlx(1:4:(N*nx)+1)'];
     testxx2 = [testxx2; ctrlx(2:4:(N*nx)+2)'];
     testxx3 = [testxx3; ctrlx(3:4:(N*nx)+3)'];
     testxx4 = [testxx4; ctrlx(4:4:(N*nx)+4)'];
    end
    x0 = ctrlx(1:nx);
    x_0 = trans(x0, ctrlx, nx, N+1);
    u_0 = transu(ctrlu, nu, N);
...
save('iterationx','testxx1');
save('iterationy','testxx2');
save('iterationtheta','testxx3');
save('iterationv','testxx4');
