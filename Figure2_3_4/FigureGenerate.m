...
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\iterationx');
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\iterationy');
...
h1 = plot(testxx1(1,:), testxx2(1,:),'c', 'LineWidth', 1);%
h2 =plot(testxx1(3,:), testxx2(3,:),'g', 'LineWidth', 1);
h3 =plot(testxx1(5,:), testxx2(5,:),'m', 'LineWidth', 1);
h4 =plot(testxx1(10,:), testxx2(10,:),'r', 'LineWidth', 1);
h5 =plot(testxx1(32,:), testxx2(32,:),'b', 'LineWidth', 1);
...
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result1');%impc-24-4-4
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result2');%impc-24-6-6
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result3');%impc-16-4-4
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result4');%impc-16-6-6
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result5');%nmpc-24-6-6
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result6');%nmpc-24-4-4
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result7');%nmpc-16-6-6
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result8');%nmpc-16-4-4
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result9');%impc-24-4
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result10');%impc-24-6
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result11');%nmpc-24-4
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\result12');%nmpc-24-6
...
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\kk-44');
...
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\kk-46'); 
...
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\kk-64');
...
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\kk-66');
...
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\iterationtheta');
load('D:\onedri\OneDrive\Desktop\shuo\Github\Figure2_3_4\iterationv');

figure(9)%Figure 3-a of paper
kk1 = 0:1:N;
hh = plot(kk1, testxx1(32,:),'r', 'LineWidth', 1);
hh1 = plot(kk1, testxx1(1,:),'r', 'LineWidth', 1);
hold on 
for i=2:1:32
if i<=20
hh1= plot(kk1, testxx1(i,:),'r', 'LineWidth', 1);
else
hh=plot(kk1, testxx1(i,:),'b', 'LineWidth', 2);
hold on 
xlim([0,24]);
end
end
...
kk1 = 0:1:N;
hh = plot(kk1, testxx2(32,:),'r', 'LineWidth', 1);
hh1 = plot(kk1, testxx2(1,:),'r', 'LineWidth', 1);
hold on 
for i=2:1:32
if i<=20
hh1= plot(kk1, testxx2(i,:),'r', 'LineWidth', 1);
else
hh=plot(kk1, testxx2(i,:),'b', 'LineWidth', 2);
hold on 
xlim([0,24]);
end
end
...
kk1 = 0:1:N;
hh = plot(kk1, testxx3(32,:),'r', 'LineWidth', 1);
hh1 = plot(kk1, testxx3(1,:),'r', 'LineWidth', 1);
hold on 
plot(kk1, testxx3(5,:),'r', 'LineWidth', 1);
plot(kk1, testxx3(11,:),'r', 'LineWidth', 1);
for i=2:1:32
if i<=20
hh1= plot(kk1, testxx3(i,:),'r', 'LineWidth', 1);
else
hh=plot(kk1, testxx3(i,:),'b', 'LineWidth', 2);
hold on 
xlim([0,24]);
end
end
...
kk1 = 0:1:N;
hh = plot(kk1, testxx4(32,:),'r', 'LineWidth', 1);
hh1 = plot(kk1, testxx4(1,:),'r', 'LineWidth', 1);
hold on 
for i=2:1:32
if i<=20
hh1= plot(kk1, testxx4(i,:),'r', 'LineWidth', 1);
else
hh=plot(kk1, testxx4(i,:),'b', 'LineWidth', 2);
hold on 
xlim([0,24]);
end
end
