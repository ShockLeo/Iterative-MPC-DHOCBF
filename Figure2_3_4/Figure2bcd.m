...
controller_nmpc_dcbf_multiple1=controller_nmpc_dcbf_multiple12.xlog;%Take the location
...
controller_nmpc_dcbf_multiple5=controller_nmpc_dcbf_multiple11.xlog;
controller_nmpc_dcbf_multiple6=controller_nmpc_dcbf_multiple21.xlog;

save('result7','controller_mpc_cbf_multiple1');%Highest order mcbf=2
save('result8','controller_mpc_cbf_multiple2');
save('result9','controller_mpc_cbf_multiple3');
save('result10','controller_mpc_cbf_multiple4');
save('result11','controller_mpc_cbf_multiple5');%Highest order mcbf=1
save('result12','controller_mpc_cbf_multiple6');
