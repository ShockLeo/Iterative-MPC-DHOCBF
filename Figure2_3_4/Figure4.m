...
kk3=getkk(6,4);
kk4=getkk(6,6);
save('kk-44','kk1');%44 corrsponds to gamma1=0.4 and gamma2=0.4 in paper
save('kk-46','kk2');%46 corrsponds to gamma1=0.4 and gamma2=0.6 in paper
save('kk-64','kk3');%64 corrsponds to gamma1=0.6 and gamma2=0.4 in paper
save('kk-66','kk4');%66 corrsponds to gamma1=0.6 and gamma2=0.6 in paper
